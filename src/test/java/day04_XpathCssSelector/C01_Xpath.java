...
public class C01_Xpath {
    public static void main(String[] args) {
        ...
        aramakutusu.submit();
        //Hybrid Bikes bölümüne tıklayın v görünür olup olmadığını,erişilebilir olup olmadığını ve seçilebilir
       // olup olmadığını, konsolda gösterin
        /*
        ...
        System.out.println(hybridBike.isDisplayed()); //WE görüntüleniyor mu?
        System.out.println(hybridBike.isEnabled()); //WE erişebiliyor mu?
        System.out.println(hybridBike.isSelected()); //WE seçilebiliyor mu?
        hybridBike.click();
